...
//     await $fetch(`/api/cwl/request/${license.licenseId}`, {
//       headers: useRequestHeaders(["cookie"]),
//     })
//       .then((response) => {
//         cwlContent.value = response.licenseText;

//         notification.resolve({
//           title: "cwl details fetched",
...
//       })
//       .catch((error) => {
//         console.error("Failed to fetch cwl details:", error);
//         notification.reject({
//           title: "Failed to fetch cwl details",
//           message: "Please try again later",
//         });
//       })
//       .finally(() => {
