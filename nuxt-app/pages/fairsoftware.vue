<template>
    <section>
      <div class="">
        <div class="flex justify-start max-w-screen-xl px-4 md:px-8 mx-auto">
          <div class="flex flex-col max-w-screen-xl py-8">
            ...
            <div
              class="py-8 flex flex-col gap-2.5 sm:flex-row sm:justify-center lg:justify-start"
            >
              <a
                href="https://doi.org/10.5281/zenodo.5504016"
                class="w-3/5 self-center md:w-auto font-inter inline-block rounded-lg bg-indigo-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-indigo-300 transition duration-100 hover:bg-indigo-600 focus-visible:ring active:bg-indigo-700 md:text-base"
                >Learn more -></a
              >
            </div>
          </div>
      ...
      <div class="bg-[#e7ddfa4f]">
        <div class="flex justify-start max-w-screen-xl px-4 md:px-8 mx-auto">
          <div class="flex flex-col mt-8 max-w-screen-xl py-8 h-auto">
            <div class="flex flex-col">
              <h2
                class="font-inter mb-4 text-xl font-bold text-black sm:text-5xl md:mb-4 md:text-4xl"
              >
      ...
      <div class="">
        <div class="flex justify-start max-w-screen-xl px-4 md:px-8 mx-auto">
          <div class="flex flex-col my-8 max-w-screen-xl py-8 h-auto">
            <div class="flex flex-col">
              <h2
                class="font-inter mb-4 text-xl font-bold text-black sm:text-5xl md:mb-4 md:text-4xl"
              >
              ...
              <div>
                ...
                <ul style="list-style-position: inside; list-style-type: disc;">
                  ...
                  <li>Increase the pace of scientific discoveries and innovations
                  </li>
                </ul>
                <p style="margin-top:1rem; padding-bottom: .2rem;">
                  In addition to promoting software development practices,
                  making software FAIR can also benefit you personally:
                </p>
                <ol style="list-style-position: inside; list-style-type: disc;">
                  <li>Get recognition when your software is reused through proper
                    citation
                  </li>
                  <li>Increase collaboration opportunities</li>
                  <li style="text-wrap: nowrap;">Position yourself for more funding opportunities as funding
                    agencies such as NIH and NSF are progressively requiring
                    funded projects to make their software FAIR
                  </li>
                </ol>
              </div>
            </div>
      ...
      <div class="bg-[#e7ddfa4f]">
        <div
          class="flex flex-col justify-start max-w-screen-xl py-4 md:py-8 px-4 md:px-8 mx-auto"
        >
          <div class="flex flex-col my-4 max-w-lg">
            ...
            <p>
              ...
              high-level framework for making software reusable and do not
              provide clear actionable instructions. Therefore, making software
              FAIR requires an in-depth understanding of each of the FAIR4RS
              Principles, and finding out how to practically comply with them.
            </p>
          </div>
          <div class="flex flex-col py-8 max-w-lg">
            <h2
              class="font-inter mb-4 text-xl font-bold text-black md:mb-4 md:text-3xl"
            >
          ...
          <div class="flex flex-col py-8 max-w-lg" style="margin-top: 2rem;">
            <h2
              class="font-inter mb-4 text-xl font-bold text-black md:mb-4 md:text-3xl"
            >
              Solution 2: codefair
