...
export default async (app, { getRouter }) => {
  ...
  app.on("pull_request.closed", async (context) => {
    ...
    // Verify if the PR was generated by the bot
    if (context.payload.pull_request.user.login !== `${GITHUB_APP_NAME}[bot]` || !["feat: ✨ LICENSE file added", "feat: ✨ Add code metadata files"].includes(context.payload.pull_request.title)) {
      return;
    }
